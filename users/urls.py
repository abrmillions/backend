...
from .views import RegisterView, MeView, LogoutView, UserViewSet, CheckEmailView, EmailVerificationRequestView, EmailVerificationConfirmView, FlexibleTokenObtainPairView, TokenLoginView
