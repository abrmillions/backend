...
class SystemSettings(models.Model):
    ...
    verified_only_true = models.BooleanField(
        default=False,
        verbose_name="Verified Only True",
        help_text="If enabled, applications can only be approved if all documents are verified."
    )
