...
# Note: The system also supports dynamic SMTP settings from the SystemSettings database.
# See users/views.py and applications/notifications.py for the dynamic implementation.
